...
function Aside() {
    ...
    return (
        <aside className="text-font bg-light rounded-3xl m-2 pb-4 sm:w-1/5 sm:p-4">
            {/* About me section */}
            <div className="flex justify-start items-center px-4 sm:flex-col sm:mt-4">
                ...
                <div className="flex justify-between w-fu">
                    <div className="flex-col">
                        ...
                        <div className="text-sm p-2 mt-2 bg-content rounded-lg flex items-center text-font sm:flex-col">
